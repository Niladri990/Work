/* NGO.js */
        ...
        const drivers = [
            { name: "Amit Verma", license: "DL654321", experience: "6 years", rating: 4.7 },
            { name: "Priya Singh", license: "DL987654", experience: "4 years", rating: 4.3 },
            { name: "Rajesh Gupta", license: "DL456789", experience: "8 years", rating: 4.9 },
            { name: "Sunita Patel", license: "DL112233", experience: "5 years", rating: 4.5 },
            { name: "Vikram Nair", license: "DL445566", experience: "7 years", rating: 4.8 },
            { name: "Anjali Kumar", license: "DL778899", experience: "3 years", rating: 4.2 },
            { name: "Ravi Joshi", license: "DL001122", experience: "9 years", rating: 4.9 },
            { name: "Meera Sharma", license: "DL334455", experience: "4 years", rating: 4.4 },
            { name: "Suresh Rao", license: "DL667788", experience: "6 years", rating: 4.6 },
            { name: "Kavita Patel", license: "DL990011", experience: "5 years", rating: 4.5 }
        ];
        ...
        function displayCenters(centers) {
            ...
            centers.forEach(center => {
                ...
                item.addEventListener('click', () => selectCenter(center));
        ...
        async function calculateRoute() {
            ...
            try {
                ...
                document.getElementById('routeInfo').textContent = 'Error calculating route';
            }
        }
